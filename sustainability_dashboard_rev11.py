...
# Rest of the dashboard code remains the same as rev07.py
# ... existing code ...
...
""".format(
    primary_theme=theme_counts.index[0],
    primary_percentage=theme_counts.values[0]/sum(theme_counts.values)
))

# Program Details section update to include provinces
